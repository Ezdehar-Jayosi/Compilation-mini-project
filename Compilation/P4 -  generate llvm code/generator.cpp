...
void set_code_gen(){
    ...
    buffer.emit("%reg4 = add i32 0, 0");
    buffer.emit("%reg5 = add i32 3, 0");
    buffer.emit("%reg6 = add i32 0, 0");
    buffer.emit("%reg7 = add i32 0, 0");
    buffer.emit("call void @printi(i32 %reg1)");
    buffer.emit("call void @printi(i32 %reg2)");
    buffer.emit("call void @printi(i32 %reg3)");
    buffer.emit("call void @printi(i32 %reg4)");
    buffer.emit("call void @printi(i32 %reg5)");
    buffer.emit("call void @printi(i32 %reg6)");
    buffer.emit("call void @printi(i32 %reg7)");
...
void llvmCaseStmt(Statement* statement, Exp* cond, CaseList* cases, string break_label, string inst_label){
